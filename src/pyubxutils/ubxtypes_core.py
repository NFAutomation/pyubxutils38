# This is taken from a different repo, copy-pasted here for simplicity 
# https://github.com/semuconsulting/pyubx2/blob/master/src/pyubx2/ubxtypes_core.py
# https://github.com/semuconsulting/pyubx2/blob/master/src/pyubx2/exceptions.py
